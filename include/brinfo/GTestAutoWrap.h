...
#define BRINFO__ASSERTION_WRAP(macro_name, raw_text, body)                     \
  do {                                                                         \
    ::BrInfo::Runtime::AssertionBegin(macro_name, __FILE__, __LINE__,          \
                                      raw_text);                               \
...
#define EXPECT_TRUE(cond)                                                      \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_TRUE", #cond,                                                    \
      EXPECT_PRED_FORMAT1(::testing::internal::IsTrue, cond))

#undef EXPECT_FALSE
#define EXPECT_FALSE(cond)                                                     \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_FALSE", #cond,                                                   \
      EXPECT_PRED_FORMAT1(::testing::internal::IsFalse, cond))

#undef EXPECT_EQ
#define EXPECT_EQ(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_EQ", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperEQ, a, b))

#undef EXPECT_NE
#define EXPECT_NE(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_NE", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperNE, a, b))

#undef EXPECT_LT
#define EXPECT_LT(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_LT", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperLT, a, b))

#undef EXPECT_LE
#define EXPECT_LE(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_LE", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperLE, a, b))

#undef EXPECT_GT
#define EXPECT_GT(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_GT", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperGT, a, b))

#undef EXPECT_GE
#define EXPECT_GE(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "EXPECT_GE", #a ", " #b,                                                 \
      EXPECT_PRED_FORMAT2(::testing::internal::CmpHelperGE, a, b))
...
#define ASSERT_TRUE(cond)                                                      \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_TRUE", #cond,                                                    \
      ASSERT_PRED_FORMAT1(::testing::internal::IsTrue, cond))

#undef ASSERT_FALSE
#define ASSERT_FALSE(cond)                                                     \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_FALSE", #cond,                                                   \
      ASSERT_PRED_FORMAT1(::testing::internal::IsFalse, cond))

#undef ASSERT_EQ
#define ASSERT_EQ(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_EQ", #a ", " #b,                                                 \
      ASSERT_PRED_FORMAT2(::testing::internal::CmpHelperEQ, a, b))

#undef ASSERT_NE
#define ASSERT_NE(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_NE", #a ", " #b,                                                 \
      ASSERT_PRED_FORMAT2(::testing::internal::CmpHelperNE, a, b))

#undef ASSERT_LT
#define ASSERT_LT(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_LT", #a ", " #b,                                                 \
      ASSERT_PRED_FORMAT2(::testing::internal::CmpHelperLT, a, b))

#undef ASSERT_LE
#define ASSERT_LE(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_LE", #a ", " #b,                                                 \
      ASSERT_PRED_FORMAT2(::testing::internal::CmpHelperLE, a, b))

#undef ASSERT_GT
#define ASSERT_GT(a, b)                                                        \
  BRINFO__ASSERTION_WRAP(                                                      \
      "ASSERT_GT", #a ", " #b,                                                 \
      ASSERT_PRED_FORMAT2(::testing::internal::CmpHelperGT, a, b))
